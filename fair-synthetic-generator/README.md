...
| ⚖️ **Multi-Paradigm Fairness** | Implements Group, Individual, and Counterfactual fairness constraints |
...
│                          ▼                                         │
│              ┌───────────────────────┐                             │
│              │   Fair Latent Space   │  ← Adversarial Debiasing   │
│              │   Z ⊥ S (Sensitive)   │                             │
│              └───────────┬───────────┘                             │
│                          │                                         │
│         ┌────────────────┼────────────────┐                        │
